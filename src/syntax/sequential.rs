...
impl ExprOp {
    pub fn to_doc(&self) -> RcDoc<()> {
        let doc = match self {
            ...
            ExprOp::App(a) => RcDoc::<()>::text("(").append(a.to_doc()).append(RcDoc::<()>::text(")")),
...
impl CopatOp {
    pub fn to_doc(&self) -> RcDoc<()> {
        let doc = match self {
            ...
            CopatOp::App(p) => RcDoc::<()>::text("(").append(p.to_doc()).append(RcDoc::<()>::text(")")),
...
impl DeconsOp {
    pub fn to_doc(&self) -> RcDoc<()> {
        let doc = match self {
            ...
            DeconsOp::App(p) => RcDoc::<()>::text("(").append(p.to_doc()).append(RcDoc::<()>::text(")")),
        };
        doc
    }
